...
<b>Não precisamos mudar nada no StyckerApp</b> quando queremos 5 valores de 5 chaves ou quando queremos 1 valor de 1 chave ou quando queremos 1.000.000 de valores de 1.000.000 de chaves <b>(basta chamarmos o método getContents que foi implementado usando Varargs de String)</b> : com um objeto [Content](https://github.com/alematema/styckers/blob/master/src/edu/undra/styckers/util/Content.java), lemos qualquer valor, de qualquer key, de apenas uma maneira : <b> content.get("key") </b>. <br><br>
